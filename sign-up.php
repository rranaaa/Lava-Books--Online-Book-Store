...
<head>
  ...
  <link rel="stylesheet" href="Cascade Sheets/headerFooter.css">
   <!--Link StyleSheet-->
  <link rel="stylesheet" type="text/css" href="Cascade Sheets/sign-up.css">
  <!--Custom Java Script-->
  <script src="Java Scripts/Signup/signup.js"></script>
  <title>Sign Up</title> 
</head>
...
<?php include "header.php"?>
  ...
  <p>Create an account.</p>
    ...
    <form class="form" action="sign-up-process.php" method="POST" autocomplete="off">
      ...
      <input type="phone" id="Phone_number" name="Phone_number"  placeholder="=01XXXXXXX" ><br><br>
