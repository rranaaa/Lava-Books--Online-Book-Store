...
<body>
    <!--Header-->
    <Header class="header" >
        <nav class="navbar" style="background-color: orangered; height: 90px">
            <div class="container-fluid" style="background-color: orangered;" >
                <a href="index.php"><img class="logo" height="100px" src="Images/Header & Footer/logo2.jpg" alt="Booklr"></a>
        ...
        <!--Navigation Bar-->        
        <div class="navigation-bar" style="height: 100px;" >
            <ul class="navigation-bar" >
                ...
                <li class="navigation-bar"><a href="cart.php" class="cart">Cart</a></li>
                <li class="navigation-bar"><a href="my-account.php" class="cart">Account</a></li>
