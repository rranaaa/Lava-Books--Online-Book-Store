...
<html lang=en>
    ...
    <Head>
         <!--Custom CSS-->
         <link rel="stylesheet" type="text/css"  href="Cascade Sheets/hf.css">
         <link rel="stylesheet" href="Cascade Sheets/faq.css">     
        <title>FAQ</title>
    </Head>
    ...
    <body>
      <?php include "./header.php"?>
        ...
        <div class="question">
            ...
            <p>If you have question regarding our Lava Books online book store (ordering, account questions, technical questions), please contact us through "Contact Us" page.</p>
        </div>
        <div class="question">
